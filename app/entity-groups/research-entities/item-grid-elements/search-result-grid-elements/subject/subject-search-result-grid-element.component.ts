...
@Component({
  selector: 'ds-subject-search-result-grid-element',
  styleUrls: ['./subject-search-result-grid-element.component.scss'],
  templateUrl: './subject-search-result-grid-element.component.html',
 ...
 */
export class SubjectSearchResultGridElementComponent extends ItemSearchResultGridElementComponent {
    // kware-edit
