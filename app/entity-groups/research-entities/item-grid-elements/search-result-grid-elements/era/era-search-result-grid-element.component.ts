...
@listableObjectComponent("EraSearchResult", ViewMode.GridElement)
@Component({
  selector: "ds-era-search-result-grid-element",
  styleUrls: ["./era-search-result-grid-element.component.scss"],
  templateUrl: "./era-search-result-grid-element.component.html",
 ...
 */
export class EraSearchResultGridElementComponent extends ItemSearchResultGridElementComponent {
  // kware-edit
