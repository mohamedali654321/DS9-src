...
@listableObjectComponent("EventSearchResult", ViewMode.GridElement)
@Component({
  selector: "ds-event-search-result-grid-element",
  styleUrls: ["./event-search-result-grid-element.component.scss"],
  templateUrl: "./event-search-result-grid-element.component.html",
 ...
 */
export class EventSearchResultGridElementComponent extends ItemSearchResultGridElementComponent {
  // kware-edit
