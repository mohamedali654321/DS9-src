...
@listableObjectComponent("SubjectSearchResult", ViewMode.ListElement)
@Component({
  selector: "ds-subject-search-result-list-element",
  styleUrls: ["./subject-search-result-list-element.component.scss"],
  templateUrl: "./subject-search-result-list-element.component.html",
  standalone: true,
  imports: [
 ...
 */
export class SubjectSearchResultListElementComponent extends ItemSearchResultListElementComponent {
  /**
